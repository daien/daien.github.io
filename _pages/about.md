...
- March 2022: 3 new papers accepted at **CVPR'22**: Multi-Frame Self-Supervised Depth with Transformers, Discovering Objects that Can Move, Revisiting the "Video" in Video-Language Understanding (soon on arxiv).
- February 2022: 4 new papers accepted at **ICRA'22**: [Full Surround Monodepth from Multiple Cameras](https://arxiv.org/abs/2104.00152) (FSM), [Self-Supervised Camera Self-Calibration from Video](https://arxiv.org/abs/2112.03325), "Learning Optical Flow, Depth, and Scene Flow without Real-World Labels" (soon on arxiv), and "Control-Aware  Prediction  Objectives  for  Autonomous  Driving" (CAPO, soon on arxiv).
- January 2022: 2 new papers accepted as **spotlights at ICLR'22**: [Self-supervised Learning is More Robust to Dataset Imbalance](https://arxiv.org/abs/2110.05025) and [Dynamics-Aware Comparison of Learned Reward Functions](https://arxiv.org/abs/2201.10081) (DARD).
