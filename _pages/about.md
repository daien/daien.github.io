...
- June 2023: 3 papers published at **CVPR'23** ([a new 3D detector using view-point equivariance (VEDet)](https://arxiv.org/abs/2303.14548), [a new video object segmentation benchmark (VOST)](https://arxiv.org/abs/2212.06200), [a new video model for object discovery from motion-guided tokens (MoTok)](https://arxiv.org/abs/2303.15555)), and a paper published at **L4DC'23** on [self-supervised in-distribution barrier functions (iDBF)](https://arxiv.org/abs/2301.12012).
